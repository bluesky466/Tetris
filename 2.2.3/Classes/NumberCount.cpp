...
NumberCount::NumberCount():
	...
	m_increment(0)
{
	CCDirector::sharedDirector()->getScheduler()->scheduleSelector(schedule_selector(NumberCount::onSchedule2),this,0.0f,false);
}

void NumberCount::setNumberLabel(UILabelAtlas* label)
{
	m_numberLabel = label;

	char str[20];
	sprintf(str,"%d",m_number);
	m_numberLabel->setStringValue(str);
